...
const ROOMS = [
  ...
  { id:'rec',  name:'Recibidor', rects:[[10.25,-9.35,12.46,-7.66],[12.46,-9.35,13.46,-7.85],
  ...
  { id:'dis',  name:'Distribuidor', rects:[[16.02,-9.30,18.97,-7.54],[18.97,-9.30,20.70,-8.38]],
...
const WALLS = [
  ...
  { a:[5.875,-5.675], b:[9.50,-5.675], t:W_TAB, holes:[[1.845,2.575,0.00,2.10,'door']] },
  { a:[5.85,-5.675], b:[5.85,-7.525], t:W_INT },
  { a:[2.385,-8.175], b:[5.90,-8.175], t:0.15 },                   // hab.1 / cocina
  { a:[5.90,-7.525], b:[9.50,-7.525], t:0.25 },                    // corrido: sin paso a la cocina
  { a:[6.975,-7.525], b:[6.975,-8.15], t:0.35 },                   // machón de la cocina
  { a:[9.39,-1.50], b:[9.39,-7.525], t:0.22, holes:[[3.22,3.92,0.00,2.10,'door']] },  // paso vestidor–estudio
  ...
  { a:[19.06,-6.445], b:[19.06,-8.32], t:0.18 },
...
const SHAFTS = [
  ...
  { x0:20.70, y0:-10.04, x1:21.50, y1: -9.26, room:'hab2', free:false,
